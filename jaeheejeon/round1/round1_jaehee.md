...
(while 문 조건이 false라 루프문에 진입하지 못합니다~)
...
range(5)는 상기 결과에서 확인이 되듯이 5번 반복이 맞습니다 파이썬이 0부터 세므로 값이 0~4로 끝날 뿐 '실행 횟수 5'와 '마지막 값 4'는 다른 개념입니다~
